...
export class PagosService {
  ...
  async confirmaPagoQr(confirmaPagoQrDto: ConfirmaPagoQrDto) {
    ...
    try {
      ...
      let correoEnviado = await this.emailService.sendMailNotifyPaymentAndAttachmentsMailtrap(correoCliente, 'Confirmación de Pago Recibida',paymentDataConfirmado, 
        reciboPath, facturaPathPdf, facturaPathXml, facturasUrl);

...
export class FacturacionCajasController {
    ...
    @Delete("factura-alquiler-anulacion") // esta funcionando correctamente
    async facturaAlquilerAnulacion(@Body() facturaAnulacionDto: FacturaAnulacionDto) {
        return await this.facturacionCajaService.facturaAlquilerAnulacion(facturaAnulacionDto);
    }
    @Delete("factura-telcom-anulacion") // anula correctamente
    async facturaTelcomAnulacio(@Body() facturaAnulacionDto: FacturaAnulacionDto) {
        return await this.facturacionCajaService.facturaTelcomAnulacion(facturaAnulacionDto);
    }
}

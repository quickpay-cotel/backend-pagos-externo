...
export class CotelDatosConfirmadoQrRepository {
  ...
  async deudasByAliasPagado(pAlias): Promise<any> {
    const query = `
    select d.codigo_deuda,d.nombre_factura,TO_CHAR(dc.fecha_registro, 'DD/MM/YYYY') AS fecha_registro,d.periodo,d.mensaje_deuda,d.mensaje_contrato,d.monto,dc.monto_sip  
